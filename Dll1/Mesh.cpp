...
namespace V10
{
		...
		m_graphics(graphics)
	{
		m_vertexData = {
		//back
		{ DirectX::XMFLOAT3(-0.5f, 0.5f, 0.5f), DirectX::XMFLOAT2(0.0f, 0.0f), DirectX::XMFLOAT3(0, 0, 1), DirectX::XMFLOAT3(1, 0, 0) },
		{ DirectX::XMFLOAT3(0.5f, -0.5f, 0.5f), DirectX::XMFLOAT2(1.0f, 1.0f), DirectX::XMFLOAT3(0, 0, 1), DirectX::XMFLOAT3(1, 0, 0) },
		...
		//left
		{ DirectX::XMFLOAT3(-0.5f, 0.5f, 0.5f), DirectX::XMFLOAT2(1.0f, 0.0f), DirectX::XMFLOAT3(-1, 0, 0), DirectX::XMFLOAT3(0, 0, 1) },
		{ DirectX::XMFLOAT3(-0.5f, -0.5f, 0.5f), DirectX::XMFLOAT2(1.0f, 1.0f), DirectX::XMFLOAT3(-1, 0, 0), DirectX::XMFLOAT3(0, 0, 1) },
		{ DirectX::XMFLOAT3(-0.5f, -0.5f, -0.5f), DirectX::XMFLOAT2(0.0f, 1.0f), DirectX::XMFLOAT3(-1, 0, 0), DirectX::XMFLOAT3(0, 0, 1) },
		{ DirectX::XMFLOAT3(-0.5f, 0.5f, -0.5f), DirectX::XMFLOAT2(0.0f, 0.0f), DirectX::XMFLOAT3(-1, 0, 0), DirectX::XMFLOAT3(0, 0, 1) },
		//right
		{ DirectX::XMFLOAT3(0.5f, 0.5f, 0.5f), DirectX::XMFLOAT2(1.0f, 0.0f), DirectX::XMFLOAT3(1, 0, 0), DirectX::XMFLOAT3(0, 0, -1) },
		{ DirectX::XMFLOAT3(0.5f, -0.5f, 0.5f), DirectX::XMFLOAT2(1.0f, 1.0f), DirectX::XMFLOAT3(1, 0, 0), DirectX::XMFLOAT3(0, 0, -1) },
		{ DirectX::XMFLOAT3(0.5f, -0.5f, -0.5f), DirectX::XMFLOAT2(0.0f, 1.0f), DirectX::XMFLOAT3(1, 0, 0), DirectX::XMFLOAT3(0, 0, -1) },
